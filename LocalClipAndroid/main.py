...
class MainScreen(Screen):
    def __init__(self, **kwargs):
        ...
        # EXIT APP Button (For when the day's work is done)
...
class EditorScreen(Screen):
    ...
    def setup_ui(self):
        ...
        for i, (txt, val) in enumerate(seeks):
            ...
            b.bind(on_release=lambda x, v=val: self.player.seek(self.position + v, relative=False) if self.player else None)
            l.add_widget(b)
