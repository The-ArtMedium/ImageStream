...
class MainWindow(QMainWindow):
    ...
    def open_metadata(self):
        ...
        layout.addRow(self.i18n.t("exif_label"), exif_box)
        layout.addRow(self.i18n.t("artist_label"), artist_input)
        layout.addRow(self.i18n.t("copyright_label"), copyright_input)
        layout.addRow(self.i18n.t("description_label"), description_input)

        note = QLabel(self.i18n.t("metadata_note"))
        ...
        if dialog.exec() == QDialog.Accepted:
            ...
            if ext not in [".jpg", ".jpeg"]:
                QMessageBox.information(self, self.i18n.t("metadata_title"), self.i18n.t("metadata_jpeg_only"))
                return
            try:
                ...
                QMessageBox.information(self, self.i18n.t("metadata_title"), self.i18n.t("metadata_success"))
            except Exception as e:
                QMessageBox.critical(self, self.i18n.t("metadata_error_title"), str(e))
